...
3. Click on Green Color 'Run All Tests in View' icon
4. Once Test Run is finished, it should show number of Passed/Failed/Skipped tests, duration of test run and a detailed summary
